...
<div id="<?php echo esc_attr($id); ?>" class="bg-ice pb-[100px] lg:pb-[90px] <?php echo esc_attr($class_name); ?>">
	<section>
		<div class="c-container__sm">
			...
			<div
				class="grid grid-cols-1 lg:grid-cols-2 grid-rows-[auto] lg:grid-rows-2 gap-4 lg:gap-y-[50px] lg:gap-x-[54px]">
				<?php if ($case_studies): ?>
					<?php foreach ($case_studies as $index => $case_study): ?>
						...
						?>
						<div
							class="<?php echo ($index === 0) ? 'col-auto lg:col-[1_/_2] lg:row-[1_/_3] h-full' : 'col-auto lg:col-[2_/_3]'; ?>	row-auto">
