    ...
    <section class="background-section relative py-10">
        <?php if ($broken_paper) :  ?>
            <?php if ($broken_paper_up) : ?>
                <div class="absolute -top-2.5 z-[1] h-20 bg-fill w-full" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/rotura_papel.png');"></div>
            <?php endif ?>
            <?php if ($broken_paper_down) : ?>
                <div class="absolute -bottom-2.5 rotate-180 z-[1] h-20 bg-fill w-full" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/rotura_papel.png');"></div>
            <?php endif ?>
        <?php endif ?>
