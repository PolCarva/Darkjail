...
?>
    ...
    <section id="<?= $block_id ?>" class="c-container__sm max-w-sceen-lg mx-auto mt-10"
        ...
        <div class="flex justify-center w-full relative">
            ...
            <!-- Tapes -->
            <img class="absolute top-0 lg:top-2 left-2 lg:left-4 -translate-x-1/2 -rotate-45 w-12 sm:w-16 md:w-20 lg:w-28 xl:w-36" src="<?php echo get_template_directory_uri(); ?>/assets/img/tape.png" alt="Cinta">
            <img class="absolute bottom-0 right-3 translate-x-1/2 -rotate-45 w-12 sm:w-16 md:w-20 lg:w-28 xl:w-36" src="<?php echo get_template_directory_uri(); ?>/assets/img/tape.png" alt="Cinta">
        </div>
